  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
      ...
      children: [
        ...
        Center(
          child: sign.resolvedReferenceImageAsset == null
              ? AnimatedSignDemo(sign: sign, size: 200)
              : ClipRRect(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    if (!supportsCamera) {
      return OutlinedButton.icon(
        ...
        label: const Text('Camera grading for this sign is coming soon'),
      );
    }
    return ElevatedButton.icon(
      ...
      label: const Text('Test with camera (A–F grade)'),
