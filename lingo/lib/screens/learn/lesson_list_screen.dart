...
class LessonListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final essentials = lessons
        .where((l) => l.category == 'essentials')
        .toList();
    final daily = lessons.where((l) => l.category == 'daily').toList();
        ...
        child: ListView(
          ...
          children: [
            ...
            if (essentials.isNotEmpty) ...[
              ...
              for (final lesson in essentials) ...[
                _LessonTile(
                  lesson: lesson,
            ...
            if (daily.isNotEmpty) ...[
              const SizedBox(height: LingoSpacing.md),
              _SectionLabel('Daily needs'),
              const SizedBox(height: LingoSpacing.sm),
              for (final lesson in daily) ...[
                _LessonTile(
                  lesson: lesson,
                  completed: completion[lesson.id] ?? false,
                  progress: progress,
